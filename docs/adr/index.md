...
Records of the decisions that shaped srcpack: what was chosen, what was rejected, and the reasoning at the time. Written when the decision is made, so they capture the trade-offs rather than a tidied-up version of them.

A record is never rewritten once accepted. When a decision is reversed, a new record supersedes it.
